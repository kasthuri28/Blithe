...
import Customer_login as cl

import CA_login as cal
import Customer_reg as cr
import CA_reg as car
def login_():
    ...
    cusButton = Button(ch, text="Customer Login",font=fnt2,bg='gray1',fg='snow',command=lambda : [f() for f in [ch.destroy,root.destroy,cl.LoginPage]])
    ...
    caButton = Button(ch, text="CA Login",font=fnt2,bg='gray1',fg='snow',command=lambda : [f() for f in [ch.destroy,root.destroy,cal.LoginPage]])
...
'''
    ...
    cusButton = Button(ch, text="Customer Register",font=fnt2,bg='gray1',fg='snow',command=lambda : [f() for f in [ch.destroy , root.destroy,o.cus_reg]])
    ...
    caButton = Button(ch, text="CA Register",font=fnt2,bg='gray1',fg='snow',command=lambda : [f() for f in [ch.destroy , root.destroy,o1.ca_reg]])
    caButton.place(x=320, y=290)
